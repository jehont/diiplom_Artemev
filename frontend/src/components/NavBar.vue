<template>
    <div class="header">
        <router-link @click="scrollToTop()" to="/" class="logo"><img src="../assets/images/logo2.png" alt="" />UFood
        </router-link>

        <nav class="navbar">
            <router-link @click="scrollToTop()" to="/">Главная страница</router-link>
            <router-link @click="scrollToTop()" to="/about">О нас</router-link>
            <router-link @click="scrollToTop()" to="/promotions">Акции</router-link>
            <router-link @click="scrollToTop()" to="/menu">Меню</router-link>
            <router-link @click="scrollToTop()" to="/table">Забронировать стол</router-link>
        </nav>
        ...
        <div class="icons">
            ...
            <div v-if="!user" class="fas fa-user account" @click="showLog">
                <ul class="drop-down-select">
                    ...
                    <li>
                        <router-link @click="scrollToTop()" to="/register">Регистрация</router-link>
                    </li>
                </ul>
            ...
            <div v-else class="fas fa-user account" style="background: #f38609;color: white;" @click="showLog">
                <ul class="drop-down-select">
                    <li>
                        <router-link @click="scrollToTop()" to="/myorder">Мои заказы</router-link>
                    </li>
                    <li>
                        <router-link @click="handleLogout" to="/">Выйти</router-link>
                    </li>
                </ul>
            </div>
